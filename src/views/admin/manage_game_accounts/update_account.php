...
<div id="update-account-modal" hidden class="QUERY-modal fixed inset-0 flex items-center justify-center z-90 p-4">
  ...
  <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] relative z-20 overflow-y-auto CSS-styled-scrollbar">
    ...
    <form id="update-account-form" class="px-6 py-4">
      <div id="pick-avatar--update-section" class="QUERY-at-avatar-input-section mb-4">
        ...
        <div class="QUERY-avatar-preview-section">
          <div class="QUERY-avatar-delete-box">
            <div class="QUERY-avatar-preview-section-box group relative overflow-hidden border border-gray-300 rounded-lg">
              ...
              <img src="" alt="Ảnh đại diện" id="avatar-preview-img--update-section" class="QUERY-avatar-1-preview-img group-hover:scale-110 transition duration-200 z-10 w-full object-contain">
            </div>
            <button type="button" id="cancel-avatar-1-btn--update-section" hidden class="flex items-center justify-center gap-2 mt-2 px-4 w-full py-1 text-sm text-white bg-red-400 border-2 border-red-400 border-solid hover:bg-transparent hover:text-red-600 rounded transition">
          ...
          <div class="QUERY-avatar-delete-box">
            <div class="QUERY-avatar-preview-section-box group relative mt-2 overflow-hidden border border-gray-300 rounded-lg">
              ...
              <img src="" alt="Ảnh đại diện" id="avatar-preview-img-2--update-section" class="QUERY-avatar-2-preview-img group-hover:scale-110 transition duration-200 z-10 w-full object-contain">
            </div>
            <button type="button" id="cancel-avatar-2-btn--update-section" hidden class="flex items-center justify-center gap-2 mt-2 px-4 w-full py-1 text-sm text-white bg-red-400 border-2 border-red-400 border-solid hover:bg-transparent hover:text-red-600 rounded transition">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trash2-icon lucide-trash-2">
                <path d="M3 6h18" />
                <path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6" />
                <path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" />
          ...
          <button type="button" id="cancel-all-avatars-btn--update-section" class="flex items-center justify-center gap-2 mt-2 px-4 w-full py-1 text-sm text-white bg-red-600 border-2 border-red-600 border-solid hover:bg-transparent hover:text-red-600 rounded transition">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trash2-icon lucide-trash-2">
              <path d="M3 6h18" />
              <path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6" />
              <path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" />
            ...
            <span>Xóa tất cả ảnh của tài khoản</span>
          </button>
        </div>
      </div>
...
<div id="confirm-remove-avatar-modal" hidden class="QUERY-modal fixed inset-0 flex items-center justify-center z-[91] p-4">
  <div class="QUERY-modal-overlay absolute z-10 inset-0 bg-black/50"></div>

  <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] relative z-20 overflow-y-auto CSS-styled-scrollbar">
    <div class="text-base py-4 px-4 font-bold">
      <p>Bạn xác nhận xóa ảnh?</p>
      <img src="" alt="Ảnh đại diện" id="avatar-preview-img--confirm-section" class="w-full mt-2 object-contain">
    </div>
    <div class="flex items-center justify-end gap-2 border-t border-gray-200 w-full p-2">
      <button class="QUERY-cancel-remove-avatar--confirm-section px-4 py-1 text-gray-700 bg-gray-200 hover:scale-110 rounded-lg transition">
        Hủy
      </button>
      <button class="QUERY-confirm-remove-avatar--confirm-section flex items-center justify-center gap-2 px-4 py-1 text-sm w-fit text-white bg-red-600 border-2 border-red-600 border-solid hover:scale-105 rounded transition">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trash2-icon lucide-trash-2">
          <path d="M3 6h18" />
          <path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6" />
          <path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" />
...
<div id="confirm-remove-all-avatars-modal" hidden class="QUERY-modal fixed inset-0 flex items-center justify-center z-[91] p-4">
  <div class="QUERY-modal-overlay absolute z-10 inset-0 bg-black/50"></div>

  <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] relative z-20 overflow-y-auto CSS-styled-scrollbar">
    <div class="text-base py-4 px-4">
      <p>Bạn xác nhận xóa tất cả ảnh của tài khoản <span class="QUERY-acc-code--confirm-section font-bold"></span>?</p>
    </div>
    <div class="flex items-center justify-end gap-2 border-t border-gray-200 w-full p-2">
      <button class="QUERY-cancel-remove-all-avatars--confirm-section px-4 py-1 text-gray-700 bg-gray-200 hover:scale-110 rounded-lg transition">
        Hủy
      </button>
      <button class="QUERY-confirm-remove-all-avatars--confirm-section flex items-center justify-center gap-2 px-4 py-1 text-sm w-fit text-white bg-red-600 border-2 border-red-600 border-solid hover:scale-105 rounded transition">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-trash2-icon lucide-trash-2">
          <path d="M3 6h18" />
          <path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6" />
          <path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" />
