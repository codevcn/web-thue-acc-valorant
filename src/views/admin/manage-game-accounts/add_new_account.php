<!-- Add Account Modal -->
<div id="add-new-account-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 hidden">
  <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
    ...
    <div class="p-6 border-t border-gray-200 flex justify-end gap-3">
      <button id="add-new-account-cancel-btn" class="px-4 py-2 text-gray-700 bg-gray-200 hover:bg-gray-300 rounded-lg transition-colors">
        Hủy
      </button>
      <button id="add-new-account-submit-btn" class="px-4 py-2 bg-gradient-to-r from-regular-from-blue-cl to-regular-to-blue-cl hover:scale-105 text-white rounded-lg transition flex items-center gap-2">
