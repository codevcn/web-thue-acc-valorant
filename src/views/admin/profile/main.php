        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white/10 rounded-2xl p-6 backdrop-blur-sm border border-white/20">
            ...
            <div class="space-y-1">
              ...
              <div class="bg-white/10 rounded-lg border p-3 border-white/40">
                <textarea name="rules" id="rules-textarea" rows="4" class="text-black w-full bg-transparent placeholder:text-gray-600 <?= $rules['rent_acc_rules'] ? '' : 'text-gray-600 text-sm' ?>" placeholder="Nhập quy định thuê acc..."><?= $rules['rent_acc_rules'] ?? 'Chưa có quy định thuê acc...' ?></textarea>
              </div>
            </div>
          </div>
