<div id="account-device-type-modal" hidden class="QUERY-modal QUERY-device-type-modal p-[80px] fixed inset-0 z-[90]">
  ...
  <div id="account-device-types" class="flex flex-wrap justify-start items-start content-start gap-2 relative z-20">
