  ...
  <div class="flex items-center justify-center min-[1072px]:flex-nowrap flex-wrap w-full gap-x-8 gap-y-4 max-h-[300px]">
    ...
    <div class="grid grid-cols-2 min-[840px]:grid-cols-4 w-full gap-x-8 gap-y-2 max-h-[300px]">
      ...
      <div id="account-rank-types-container" class="flex-1">
        <p class="text-base font-medium mb-1 flex items-center gap-2 pl-1">
          <svg
      ...
      <!-- Actions -->
      <div class="w-full">
        <p class="text-base font-medium mb-1 items-center gap-2 pl-1 opacity-0 flex">
          <span>Hủy lọc</span>
        </p>
        <button id="cancel-all-filters-btn" class="flex items-center gap-2 w-full h-[35px] bg-red-600 hover:scale-105 text-white rounded-lg px-4 py-1.5 text-base font-medium transition duration-200">
