  ...
  <div class="relative z-10 min-h-screen flex items-center font-bold">
    <div class="w-full px-2 py-[30px] min-[1600px]:px-[150px]">
      <div class="w-full">
        ...
        <div class="grid min-[1170px]:grid-cols-2 grid-cols-1 gap-y-2 gap-x-2 items-start">
          <div class="space-y-2">
            <div class="flex gap-2 min-[600px]:flex-row flex-col">
              <div class="bg-white/10 backdrop-blur-md rounded-2xl p-3 min-[1441px]:p-5 border border-white/20 flex-1">
                ...
                <div class="space-y-2 text-[1.29em] mt-4">
                  <div class="flex items-center gap-3 text-sky-400">
                    ...
                    <span class="text-white">
                      ...
                      <span class="text-gray-300 ml-2">(22PM - 7AM)</span>
                    </span>
                  </div>
              ...
              <div class="bg-yellow-500/10 backdrop-blur-md rounded-2xl p-3 border border-white/20 flex-1">
            ...
            <div class="bg-gradient-to-r from-sky-500/20 to-cyan-500/20 backdrop-blur-md rounded-2xl p-3 min-[1441px]:p-5 border border-sky-300/30">
              <h3 class="font-bold text-sky-300 mb-4 flex items-center gap-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6">
                ...
                <span class="text-[1.71em]">ƯU ĐÃI ĐẶC BIỆT</span>
              </h3>
              <div class="space-y-2 text-[1.29em]">
                <div class="flex items-center gap-3 text-sky-400">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6">
            ...
            <div class="flex-col items-center gap-3 min-[1170px]:flex hidden pt-2">
          ...
          <div class="flex gap-2 items-stretch min-[600px]:flex-row flex-col">
            <div class="bg-red-500/10 backdrop-blur-md rounded-2xl p-3 min-[1441px]:p-5 border border-white/20 flex-1">
              ...
              <div class="text-[1.14em]">
                <div class="break-normal">
                  ...
                  <span class="text-white font-semibold">Lấy cọc </span>
                  <span class="text-yellow-500"><span class="text-white">(</span>sau khi chơi xong gửi mã QR, bên mình sẽ tiến hành kiểm tra Account nếu không vấn đề gì sẽ tiến hành hoàn
                    cọc và thông báo</span><span class="text-white">)</span>
                </div>

                <div class="break-normal">
                  <span class="text-white">-</span>
                  <span class="text-red-400 font-bold">AFK</span>
                  <span class="text-white">bị ban hàng chờ</span>
                  <span class="text-red-400 font-bold">- 20k</span>
                  <span class="text-white">(Bị thông báo AFK</span>
                  <span class="text-red-400 font-bold">- 10k</span><span class="text-white">)</span>
                  <span class="text-white"> bất kể lí do nào !</span>
                </div>

                <div class="break-normal">
                  <span class="text-white">-</span>
                  <span class="text-red-400 font-bold">Bị Cấm Chat</span>
                </div>

                <div class="break-normal">
                  <span class="text-white">-</span>
                  <span class="text-red-400 font-bold">Chơi quá giờ</span>
                  <span class="text-white">(Hết giờ thuê mà vẫn còn trong trận) bất kể lí do nào !</span>
                </div>

                <div class="break-normal">
                  <span class="text-white">-</span>
                  <span class="text-white">Bất kể việc gì khiến bạn không thể chơi được tiếp (trừ việc hết giờ)</span>
                  <span class="text-yellow-400">phải thông báo lại cho admin hỗ trợ</span>
                </div>

                <div class="break-normal">
                  <span class="text-red-400 font-bold">- Không toxic, không smuff</span>
                </div>

                <div class="break-normal">
                  <span class="text-white">( Sẽ có</span>
                  <span class="text-sky-400 font-bold">khuyến mãi</span>
                  <span class="text-white">cho những bạn để cọc )</span>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-3 min-[1441px]:p-5 border border-white/20 flex-1">
              <div class="mb-6 px-2 rounded-lg">
                <h1 class="text-pink-400 text-[1.71em] font-bold">Giới thiệu</h1>
              </div>
              ...
              <div class="space-y-4 text-[1.14em]">
                <span class="text-white whitespace-pre-line">- Dịch vụ cho thuê Account Valorant giá rẻ nhất thị trường, hỗ trợ tốt, an toàn, nhanh chóng.
                  ...
                  - cầm cố Account nhận tiền sau 7 ngày
                  Thân ái !
                  Phục vụ từ tâm - duonganhtuan.
                </span>
              </div>
            </div>
          </div>
