...
<body class="bg-gradient-to-br from-regular-from-blue-cl via-regular-via-blue-cl to-regular-to-blue-cl text-[14px] min-[1366px]:text-[16px] min-[1800px]:text-[24px] min-[2200px]:text-[38px]">
