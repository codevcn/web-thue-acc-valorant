...
<div id="commitment-modal" hidden class="flex justify-center p-6 items-center overflow-hidden fixed inset-0 z-[990]">
  ...
  <div
    ...
    <div class="mb-2">
      ...
      <div
        class="bg-transparent border border-white/20 border-solid w-full max-h-full overflow-y-auto CSS-styled-scrollbar px-3 py-2 rounded-md text-sm text-white focus:outline-none focus:ring-2 focus:ring-regular-light-blue-cl">
