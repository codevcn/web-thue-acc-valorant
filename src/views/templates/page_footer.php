  ...
  <div class="mx-auto px-10 pt-8 pb-4">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-8">
      <div href="/" class="space-y-6">
        ...
        <div>
          <h3 class="CSS-small-text-stroke text-2xl font-bold text-white mb-4">thueaccvaloranttime.com</h3>
      ...
      <div class="space-y-6">
        <h4 class="text-xl font-bold text-black/80">Liên hệ</h4>
        <div class="space-y-4">
          <p class="text-black/80 text-base">Liên hệ với chúng tôi qua các kênh mạng xã hội</p>
          <div class="flex flex-col space-y-3">
            <a href="<?= $admin['facebook_link'] ?>" class="flex items-center gap-3 w-fit text-white transition-all duration-300">
              <div class="w-10 h-10 bg-regular-facebook-cl rounded-full flex items-center justify-center transition-colors duration-300">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
