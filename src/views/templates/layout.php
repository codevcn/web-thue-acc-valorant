...
<button id="scroll-to-top-btn" class="outline-2 outline outline-white fixed bottom-[-4.26em] right-6 bg-gradient-to-r from-regular-from-blue-cl to-regular-to-blue-cl text-white p-2 rounded-full shadow-lg hover:scale-110 transition-[bottom,transform] duration-300 z-50">
